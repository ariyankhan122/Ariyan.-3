...
module.exports.handleEvent = async function ({ api, event }) {
  ...
  const responses = {
    ...
    "miss u too": "হুম আমি ও তোমাকে Miss করি... কিন্তু আরিয়ান বস বেশি করে 😏💖",
    ...
    "good night": "Sweet Dream babu… তবে আগে আরিয়ান বস কে GN বলে নিও 😏💤",
    "tor ball": "~ এখনো বাল উঠে নাই নাকি তোমার?? 🤖",
    "shahadat": "উনি এখন কাজে বিজি আছে কি বলবেন আমাকে বলতে পারেন..!😘",
    "owner": "‎[𝐎𝐖𝐍𝐄𝐑:☞ ARIYAN ☜\nFacebook: https://www.facebook.com/5G.TAMU78\nWhatsApp: +966572373693",
    "admin": "He is ARIYAN তাকে সবাই Admin ARIYAN হিসেবে চিনে😘☺️",
    ...
    "tor nam ki": "MY NAME IS ─꯭─⃝‌‌𝐀𝐫𝐢𝐲𝐚𝐧 𝐂𝐡𝐚𝐭 𝐁𝐨𝐭💖",
    ...
    "ki koros": "বস আরিয়ান এর সাথে প্রেমে ব্যস্ত আছি 😏💘",
    "kire bot": "হ্যাঁ সব কেমন আছেন আপনার ওই খানে উম্মাহ 😘😽🙈",
    "valo aso": "হ্যাঁ রে প্রিও, বস আরিয়ান এর দোয়ায় ভালো আছি 😌💞",
    "pagol": "হুম পাগল, কিন্তু তোমারই পাগল 😏😂",
    "breakup": "চিন্তা করিস না… আরিয়ান বস তো আছেই তোকে নতুন জন দিয়া দিবে 😎🔥",
    "tui ke": "আমি তোর বস আরিয়ান এর ChatBot 😏",
    "umm": "এতো Umm কেনো জানু… কিছু বলবা? 😉",
    "hmm": "Hmmm কিসের হুমম জানু 🥵",
    "love": "Love করলে সরাসরি আরিয়ান বস কে বল জানু 😻🔥"
  };
